...
<div class='sectiony'>
<div class='row'>
<div class='col-sm-6' id='photo-frame-1'>
</div>
<div class='col-sm-6' id='photo-frame-2'>
</div>
</div>
</div>
...
<button class='but'>Process</button>
...
function processPhoto(){
  ...
  var canvas = document.getElementById("gsphoto");
  var context = canvas.getContext('2d');
  ...
  for (var i = 0; i < pixels.length; i += 4) {
      ...
      var blue = pixels[i + 2];
      var gs = parseInt((pixels[i] + pixels[i + 1] + pixels[i + 2]) / 3);
      var hue = rgbToHsl(red, green, blue)[0];
      var sat = rgbToHsl(red, green, blue)[1];
      var hex = rgbToHex(red, green, blue);
      data.push({photo_label: photo_label, red: red, green: green, blue: blue, hue: hue, saturation: saturation, grayscale: gs, hex_code: hex})
  }
  
  shuffle(data);
  var sampled_data = data.slice(0, min(sample_size, pixels.length/4))
  doStuff(data);
}
